...
//           </p>
//           <div className="files">
//             <a className="more-details view-button" href="LINK_TO_FRIENDS_LIST" target="_blank" rel="noopener noreferrer">
//               לרשימת החברים לחץ כאן
//             </a>
//             <a className="more-details view-button" href="LINK_TO_RULES" target="_blank" rel="noopener noreferrer">
//               לתקנון האתר לחץ כאן
//             </a>
//           </div>
//         </div>
